...
const https_key = fs.readFileSync(process.env.CERT_LOCATION + 'privkey.pem', 'utf8')
const https_cert = fs.readFileSync(process.env.CERT_LOCATION + 'fullchain.pem', 'utf8')
